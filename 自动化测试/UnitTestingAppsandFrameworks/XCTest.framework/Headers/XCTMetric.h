...
*/
@property (readonly, class) XCTOSSignpostMetric *applicationLaunchMetric API_DEPRECATED("Use XCTApplicationLaunchMetric instead", macos(10.15, 11.0), ios(13.0, 14.0), tvos(13.0, 14.0));
...
*/
- (instancetype)initWithWaitUntilResponsive:(BOOL)waitUntilResponsive API_AVAILABLE(macos(11.0), ios(14.0), tvos(14.0));
